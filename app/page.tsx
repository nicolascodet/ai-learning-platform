          ...
          <div className="flex justify-between h-16">
            <div className="flex">
              <div className="flex-shrink-0 flex items-center">
                <span className="text-xl font-bold text-indigo-600">Learning Platform</span>
              </div>
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Access interactive courses, track your progress, and master new skills with our cutting-edge learning platform.
                </p>
              ...
              {[
                {
                  ...
                  description: 'Learn with hands-on exercises and real-world projects.'
                },
                {
                ...
                },
                {
                  ...
                  description: 'Get help from our community of educators and learners.'
                },
                {
